...
export const GET_SEARCH_DEPARTMENTS_REQUEST = "GET_SEARCH_DEPARTMENTS_REQUEST";
export const GET_SEARCH_DEPARTMENTS_SUCCESS = "GET_SEARCH_DEPARTMENTS_SUCCESS";
export const GET_SEARCH_DEPARTMENTS_FAILED = "GET_SEARCH_DEPARTMENTS_FAILED";
