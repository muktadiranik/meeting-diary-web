...
export const getCommitteeDetailsAction = (departmentId, committeeId) => async (dispatch, getState) => {
  dispatch({ type: GET_COMMITTEE_DETAILS_REQUEST });
  const {
    authReducer: { token },
  } = getState();
  axios
    .get(`${process.env.REACT_APP_API_URL}/departments/${departmentId}/committees/${committeeId}/`, {
      headers: {
...
export const addCommitteeAction = (departmentId, title, description, member) => async (dispatch, getState) => {
...
export const getAllCommitteesAction = (departmentId) => async (dispatch, getState) => {
  dispatch({ type: GET_ALL_COMMITTEES_REQUEST });
  const {
    authReducer: { token },
  } = getState();
  axios
    .get(`${process.env.REACT_APP_API_URL}/departments/${departmentId}/committees/`, {
      headers: {
        Authorization: `JWT ${token}`,
      },
    })
...
export const getSearchCommitteesAction = (departmentId, search) => async (dispatch, getState) => {
  dispatch({ type: GET_SEARCH_COMMITTEES_REQUEST });
  const {
    authReducer: { token },
  } = getState();
  axios
    .get(`${process.env.REACT_APP_API_URL}/departments/${departmentId}/committees/?search=${search}`, {
      headers: {
        Authorization: `JWT ${token}`,
      },
    })
...
export const deleteCommitteeAction = (departmentId, committeeId) => async (dispatch, getState) => {
  ...
  toast
    .promise(
      axios.delete(`${process.env.REACT_APP_API_URL}/departments/${departmentId}/committees/${committeeId}/`, {
        headers: {
          Authorization: `JWT ${token}`,
        },
      }),
...
export const getUpdateCommitteeAction = (departmentId, committeeId) => async (dispatch, getState) => {
...
export const updateCommitteeAction = (departmentId, committeeId, title, description, member) => async (dispatch, getState) => {
