...
export const getAllMembersAction = (departmentId) => async (dispatch, getState) => {
  dispatch({ type: GET_ALL_MEMBERS_REQUEST });
  const {
    authReducer: { token },
  } = getState();
  axios
    .get(`${process.env.REACT_APP_API_URL}/departments/${departmentId}/members/`, {
      headers: {
...
export const getSearchMembersAction = (departmentId, search) => async (dispatch, getState) => {
  dispatch({ type: GET_SEARCH_MEMBERS_REQUEST });
  const {
    authReducer: { token },
  } = getState();
  axios
    .get(`${process.env.REACT_APP_API_URL}/departments/${departmentId}/members/?search=${search}`, {
      headers: {
        Authorization: `JWT ${token}`,
      },
    })
...
export const addMemberAction = (departmentId, member) => async (dispatch, getState) => {
  ...
  toast
    .promise(
      axios.post(`${process.env.REACT_APP_API_URL}/departments/${departmentId}/members/`, member, {
        headers: {
          Authorization: `JWT ${token}`,
        },
      }),
...
export const deleteMemberAction = (departmentId, memberId) => async (dispatch, getState) => {
  ...
  toast
    .promise(
      axios.delete(`${process.env.REACT_APP_API_URL}/departments/${departmentId}/members/${memberId}/`, {
        headers: {
          Authorization: `JWT ${token}`,
        },
      }),
...
export const getUpdateMemberAction = (departmentId, memberId) => async (dispatch, getState) => {
  ...
  axios
    .get(`${process.env.REACT_APP_API_URL}/departments/${departmentId}/members/${memberId}/`, {
      headers: {
        Authorization: `JWT ${token}`,
      },
    })
...
export const updateMemberAction = (departmentId, memberId, member) => async (dispatch, getState) => {
  ...
  toast
    .promise(
      axios.put(`${process.env.REACT_APP_API_URL}/departments/${departmentId}/members/${memberId}/`, member, {
        headers: {
          Authorization: `JWT ${token}`,
        },
      }),
